...
<div id="main-content">
    <h2>eidt New Record</h2>

    <form class="post-form" action="{{route('product.update',['id'=>$product->id])}}" method="post">
        @csrf
        {{method_field('PUT')}}
        ...
        <div class="form-group">
            <label>Details</label>
            <input type="text" name="detail" value="{{$product->detail}}"required/>
        </div>
